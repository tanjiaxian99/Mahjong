...
namespace Tests {
    ...
    public class HighRiskTilesTest {
        ...
        public HighRiskTilesTest() {
            ...
            payAllDiscard = new HighRiskTiles(handsToCheck);
        }
        ...
        public void DragonTileSetTest() {
            ...
            List<Tile> actualHighRiskTiles = payAllDiscard.HighRiskDiscards(openTiles, playerWind, prevailingWind);
